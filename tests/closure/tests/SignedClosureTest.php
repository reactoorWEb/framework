...
use illustrate\Closure\SecurityException;
...
class SignedClosureTest extends ClosureTest
{
    public function testSecureClosureIntegrityFail()
    {
        if (method_exists($this, 'expectException')) {
            $this->expectException('\illustrate\Closure\SecurityException');
        } else {
            $this->setExpectedException('\illustrate\Closure\SecurityException');
        }
