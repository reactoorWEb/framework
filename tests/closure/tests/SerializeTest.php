...
class SerializeTest extends \PHPUnit\Framework\TestCase
{
    public function testCustomSerialization()
    {
        ...
        $a = new Abc($f);
        $u = \illustrate\Closure\unserialize(\illustrate\Closure\serialize($a));
    ...
    {
        $a = new A2();
        $a = \illustrate\Closure\unserialize(\illustrate\Closure\serialize($a));
    ...
    public function testPrivateMethodClone2()
    {
        ...
        $u = \illustrate\Closure\unserialize(\illustrate\Closure\serialize($f));
    ...
    public function testNestedObjects2()
    {
        ...
        $u = \illustrate\Closure\unserialize(\illustrate\Closure\serialize($parent))->closure;
        $this->assertTrue($u());
    }
    ...
    public function testNestedObjects3()
    {
        ...
        $u = \illustrate\Closure\unserialize(\illustrate\Closure\serialize($obj));
        $c = $u->closure;
        $this->assertTrue($c($u));
    }
    ...
    public function testNestedObjects4()
    {
        ...
        $u = \illustrate\Closure\unserialize(\illustrate\Closure\serialize($parent));
        $c = $u->closure;
        $this->assertTrue($c($u));
    }
    ...
    public function testPrivatePropertyInParentClass()
    {
        ...
        $u = \illustrate\Closure\unserialize(\illustrate\Closure\serialize($closure));
    ...
    public function testInternalClass3()
    {
        ...
        $u = \illustrate\Closure\unserialize(\illustrate\Closure\serialize($instance));
    ...
    {
        $o = (object)['foo'=>'bar'];
        $s1 = \illustrate\Closure\serialize($o);
        $o = \illustrate\Closure\unserialize($s1);
        $s2 = \illustrate\Closure\serialize($o);
    ...
    public function testIfThisIsCorrectlySerialized() {
        $o = new Clone1();
        $f = $o->create();
        $f = \illustrate\Closure\unserialize(\illustrate\Closure\serialize($f));
        $f = \illustrate\Closure\unserialize(\illustrate\Closure\serialize($f));
