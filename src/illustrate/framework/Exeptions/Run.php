...
use Throwable;
use illustrate\Exeptions\Exception\ErrorException;
use illustrate\Exeptions\Handler\CallbackHandler;
use illustrate\Exeptions\Handler\Handler;
use illustrate\Exeptions\Handler\HandlerInterface;
use illustrate\Exeptions\Inspector\CallableInspectorFactory;
use illustrate\Exeptions\Inspector\InspectorFactory;
use illustrate\Exeptions\Inspector\InspectorFactoryInterface;
use illustrate\Exeptions\Inspector\InspectorInterface;
use illustrate\Exeptions\Util\Misc;
use illustrate\Exeptions\Util\SystemFacade;
...
final class Run implements RunInterface
{
    ...
    public function register()
    {
        if (!$this->isRegistered) {
            ...
            class_exists("\\Reactoor\Phoenix\Exeptions\\Exception\\ErrorException");
            class_exists("\\Reactoor\Phoenix\Exeptions\\Exception\\FrameCollection");
            class_exists("\\Reactoor\Phoenix\Exeptions\\Exception\\Frame");
            class_exists("\\Reactoor\Phoenix\Exeptions\\Exception\\Inspector");
            class_exists("\\Reactoor\Phoenix\Exeptions\\Inspector\\InspectorFactory");
