...
use illustrate\JsonSchema\Exceptions\UnresolvedReferenceException;
use illustrate\JsonSchema\{JsonPointer, Schema, SchemaLoader, Uri, ValidationContext, Variables};
