...
namespace illustrate\JsonSchema\Parsers\Pragmas;

use illustrate\JsonSchema\Pragma;
use illustrate\JsonSchema\Info\SchemaInfo;
use illustrate\JsonSchema\Pragmas\GlobalsPragma;
use illustrate\JsonSchema\Parsers\{PragmaParser, SchemaParser, VariablesTrait};
