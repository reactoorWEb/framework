...
use illustrate\JsonSchema\Parsers\Keywords\{
    FiltersKeywordParser,
    SlotsKeywordParser
};
use illustrate\JsonSchema\Parsers\Pragmas\{CastPragmaParser, GlobalsPragmaParser,
    MaxErrorsPragmaParser, SlotsPragmaParser};
use illustrate\JsonSchema\Parsers\KeywordValidators\PragmaKeywordValidatorParser;
