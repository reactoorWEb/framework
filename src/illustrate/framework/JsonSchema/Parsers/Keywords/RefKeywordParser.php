...
use illustrate\Uri\UriTemplate;
use illustrate\JsonSchema\Info\SchemaInfo;
use illustrate\JsonSchema\{Keyword, Schema, JsonPointer, Uri};
use illustrate\JsonSchema\Parsers\{KeywordParser, SchemaParser, VariablesTrait};
use illustrate\JsonSchema\Keywords\{PointerRefKeyword, RecursiveRefKeyword, TemplateRefKeyword, URIRefKeyword};
